...
const Reports = () => {
    ...
    return (
        <div className=" max-w-7xl mx-auto bg-[#C1DDF8] min-h-screen">
            {/* Stats Grid */}
            <div className="grid grid-cols-5 gap-4 mb-6 p-6">
            ...
            {/* Filters */}
            <div className="flex items-center justify-between mb-6 bg-white p-4 rounded-2xl border border-gray-200 shadow-sm mx-6">
                {/* Filters */}
                <div className="flex items-center gap-2 " >
                    {/* Date Range */}
                    <div className="flex items-center gap-2 bg-[#EAF1F3] rounded-md pl-2 py-2">
                        <img src="/Icon.png" alt="date icon" className="w-4 h-4" />
                        <p className="text-sm text-[#334155] font-medium bg-transparent border-none focus:outline-none w-24">
                            Date Range
                        </p>
                    </div>

                    {/* User */}
                    <div className="flex items-center gap-2 bg-[#EAF1F3] rounded-md px-2 py-2">
                        <img src="/Container.png" alt="user icon" className="w-4 h-4" />
                        <select className="text-sm text-[#334155] font-medium bg-transparent border-none focus:outline-none w-17">
                            <option>User</option>
                        </select>
                    </div>
                    ...
                    <div className="flex items-center gap-2 bg-[#EAF1F3] rounded-md px-2 py-2">
                        ...
                        <select className="text-sm text-[#334155] font-medium bg-transparent border-none focus:outline-none w-28">
                    ...
                    <div className="flex items-center gap-2 bg-[#EAF1F3] rounded-md px-2 py-2">
                        ...
                        <select className="text-sm text-[#334155] font-medium bg-transparent border-none focus:outline-none w-24">
                ...
                {/* Clear all filters */}
                <button className="text-sm text-[#1A8FA0] hover:text-blue-800 font-medium cursor-pointer">
                    Clear all filters
                </button>
            </div>

            {/* Table and Details Panel Side by Side */}
            <div className="flex gap-4 p-6">
                ...
                <div className="flex-1 bg-white rounded-2xl border border-gray-200 overflow-hidden shadow-sm">
                    ...
                    <div className="px-4 py-3 bg-white flex items-center justify-between border-t border-gray-200">
                        ...
                        {/* Right side - Page Numbers and Arrows */}
                        <div className="flex items-center gap-2">
                            {/* Previous Arrow */}
                            <button className="text-sm text-gray-600 hover:bg-gray-100 rounded "><img src="/l.png" alt="" className='h-7 w-7 rounded-lg cursor-pointer' /></button>
                            ...
                            {/* Next Arrow */}
                              <button className="text-sm text-gray-600 hover:bg-gray-100 rounded "><img src="/r.png" alt="" className='h-7 w-7 rounded-lg cursor-pointer' /></button>
                        </div>
                    </div>
                </div>

                {/* Log Details Panel - Right Side */}
                <div className="w-96 bg-white rounded-2xl border border-gray-200 shadow-sm flex flex-col">
                    ...
                    <div className="flex-1 overflow-y-auto p-4">
                        ...
                        <div>
                            <div className="flex items-center  gap-2"   >
                                ...
                                <select className="text-sm font-bold text-black mb-2 w-82  "><option value="">DATA SNAPSHOT</option></select>
                            </div>
                            <button className="text-sm border-2 border border-dashed rounded-xl border-gray-200 py-4 px-12 text-[#94A3B8] hover:text-blue-800">
