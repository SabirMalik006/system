...
export default function ProcurementRequestsTable() {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-4 gap-4">
      ...
      <div className="lg:col-span-3 bg-white h-[480px] rounded-2xl border border-gray-100 shadow-sm p-4 ">
          ...
          <table className="w-full text-xs min-w-[800px] lg:min-w-0">
            <thead>
              <tr className="border-b border-gray-100 bg-[#1F68B2]">
                <th className="text-left py-2 px-6  text-[10px] font-semibold text-white tracking-wider whitespace-nowrap w-[80px]">Request ID</th>
                <th className="text-left py-2 px-2 text-[10px] font-semibold text-white tracking-wider whitespace-nowrap w-[70px]">Department</th>
                <th className="text-left py-2 px-3 text-[10px] font-semibold text-white tracking-wider whitespace-nowrap w-[60px]">Unit</th>
                <th className="text-left py-2 px-3 text-[10px] font-semibold text-white tracking-wider whitespace-nowrap w-[100px]">Requested By</th>
                <th className="text-left py-2 -px-2 text-[10px] font-semibold text-white tracking-wider whitespace-nowrap w-[40px]">Items</th>
                <th className="text-left py-2 px-5 text-[10px] font-semibold text-white tracking-wider whitespace-nowrap w-[70px]">Status</th>
                <th className="text-left py-2 px-7 text-[10px] font-semibold text-white tracking-wider whitespace-nowrap w-[90px]">Vendor</th>
                <th className="text-left py-2 px-7 text-[10px] font-semibold text-white tracking-wider whitespace-nowrap w-[80px]">PO No.</th>
                <th className="text-left py-2 px-2 text-[10px] font-semibold text-white tracking-wider whitespace-nowrap w-[50px]">Amount</th>
                <th className="text-left py-2 px-7 text-[10px] font-semibold text-white tracking-wider whitespace-nowrap w-[70px]">Date</th>
                <th className="text-left py-2 px-6 text-[10px] font-semibold text-white tracking-wider whitespace-nowrap w-[60px]">Actions</th>
              </tr>
            </thead>
            <tbody>
              {tableData.map((row, i) => (
      ...
      {/* Detail Panel - Reduced width */}
      <div className="lg:col-span-1 bg-[#fff] rounded-2xl  shadow-sm  h-full">
        <div className="mb-3 bg-[#1E4D7B] rounded-md px-3 py-2  ">
          <div className="text-white font-black text-base">{detailData.id}</div>
          <div className="text-xs text-gray-400 mt-0.5">{detailData.sub}</div>
        </div>
