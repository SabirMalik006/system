                ...
                <div className="flex flex-col lg:grid lg:grid-cols-3 gap-6">
                    ...
                    <div className="lg:col-span-2 space-y-6 order-2 lg:order-none">
                        ...
                        <div className="flex flex-wrap items-center justify-end gap-3">
                            ...
                            <button className="px-4 sm:px-6 py-2.5 text-sm text-white bg-gradient-to-b from-[#1E4D7B] to-[#1E4D7B] rounded-lg hover:from-[#1D4ED8] hover:to-[#1976D2] transition-all shadow-sm">
