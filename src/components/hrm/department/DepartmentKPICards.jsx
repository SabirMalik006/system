...
const kpiData = [
  {
    ...
    label: 'Total Employees', value: '1,240', sub: '~ +2.5%', subColor: 'text-gray-100',
  },
  {
    icon: (
      <svg className="w-5 h-5 text-[#244f77]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    label: 'Active', value: '1,180', sub: 'Stable parity', subColor: 'text-gray-300',
  },
  {
    icon: (
      <svg className="w-5 h-5 text-[#244f77]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    label: 'On Leave', value: '42', sub: '~ -6.1%', subColor: 'text-gray-100',
  },
  {
    icon: (
      <svg className="w-5 h-5 text-[#244f77]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    label: 'Pending Updates', value: '26', sub: '1 High Priority', subColor: 'text-gray-100',
  },
  {
    icon: (
      <svg className="w-5 h-5 text-[#244f77]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    label: 'Suspended', value: '4', sub: '1 High Priority', subColor: 'text-gray-100',
  },
];
    ...
    <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3">
      {kpiData.map((kpi, i) => (
        <div key={i} className="bg-[#244a70] rounded-xl p-4 flex items-center gap-3 border border-[#325a81] shadow-sm">
          <div className="bg-white rounded-lg p-2.5 flex-shrink-0 shadow-sm">{kpi.icon}</div>
          <div>
