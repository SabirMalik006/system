    ...
    <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
      ...
      <div>
        <h1 className="text-xl font-black text-gray-900 leading-tight">
          ...
          <span className="text-gray-800"><br /> Analytics</span>
        </h1>
      ...
      <div className="flex items-center gap-2 flex-shrink-0">
        ...
        {/* Export Report */}
        <button className="flex items-center gap-1.5 bg-[#1a3a8f] hover:bg-blue-900 text-white text-xs font-bold px-3 py-2 rounded-lg transition-colors">
          <Download size={13} />
