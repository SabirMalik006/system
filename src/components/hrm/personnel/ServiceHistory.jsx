            ...
            {entries.map((entry, i) => (
              ...
              >
                ...
                <td className="px-4 py-3 text-center">
                  {entry.comp ? (
                    <button onClick={() => removeEntry(i)} className={`${i % 2 === 0 ? 'text-black hover:text-white' : 'text-white hover:text-red-500'} transition-colors cursor-pointer`}>
                      <Plus size={15} />
                    </button>
                  ) : (
                    <button onClick={addEntry} className={`${i % 2 === 0 ? 'text-black hover:text-white' : 'text-black hover:text-black'} transition-colors cursor-pointer`}>
                      <Trash2 size={15} />
                    </button>
                  )}
                </td>
